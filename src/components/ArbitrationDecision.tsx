  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
      ...
      <div className="space-y-4 sm:space-y-6">
        {/* Decision Outcome */}
        <div>
          <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4">Decision Outcome</h3>
          <div className="space-y-3 sm:space-y-3">
            <label className="flex items-center gap-2 sm:gap-3">
              ...
              />
              <span className="text-sm sm:text-base text-gray-900 font-medium">Release funds to Seller</span>
            </label>
            <label className="flex items-center gap-2 sm:gap-3">
              <input
                type="radio"
                ...
                className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
              />
              <span className="text-sm sm:text-base text-gray-900 font-medium">Refund funds to Buyer</span>
            </label>
            <label className="flex items-center gap-2 sm:gap-3">
              <input
                type="radio"
                ...
                className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
              />
              <span className="text-sm sm:text-base text-gray-900 font-medium">Split funds (e.g., 50/50)</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4">Justification / Comments</h3>
          <textarea
            value={comments}
